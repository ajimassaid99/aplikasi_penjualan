...
import 'package:solusi_penjualan_pangan/page/register.dart';
      ...
      listener: (context, state) {
        ...
        if (state is LoginSucces) {
          Navigator.pushAndRemoveUntil(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  const DashboardUserPage(), // Ganti dengan nama halaman login Anda
            ),
            (route) => false,
          );
        }
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const Text(
                          'Berbelanja mudah, dengan hanya satu klik. Soo Easy',
                          style: TextStyle(
                            fontFamily: 'Itim',
                            fontSize: 13,
                            fontWeight: FontWeight.w400,
                            ...
                            letterSpacing: 0.0,
                            color: Colors
                                .black, // Warna teks sesuai kebutuhan Anda
                          ),
                        ),
                        const SizedBox(height: 10),
                        // Padding(
                        ...
                        ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const RegisterUserPage(), // Ganti dengan nama halaman login Anda
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
